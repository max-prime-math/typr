...
The default [`compose.yaml`](https://github.com/max-prime-math/typr/blob/main/compose.yaml) runs the full image on loopback:
...
[`templates/typr.xml`](https://github.com/max-prime-math/typr/blob/main/templates/typr.xml) is the Typr web template. It uses
