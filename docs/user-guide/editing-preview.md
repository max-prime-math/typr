...
The editor supports themes, Vim-compatible editing, relative line numbers, snippets, formatting and linting tools where available, and configurable keybindings. Settings search can find editor, theme, keybinding, snippet, package, and Git options quickly.
